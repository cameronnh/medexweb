...
GO
PRINT N'Creating [dbo].[doctorPatients]...';
...
GO
PRINT N'Creating [dbo].[patientPrescriptions]...';
...
GO
ALTER TABLE [dbo].[doctorPatients]
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '5ca1f827-1d2d-4794-b07f-902fd9d8232d')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('5ca1f827-1d2d-4794-b07f-902fd9d8232d')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '551d3b6b-d9af-4be4-8229-a94bd1fe5767')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('551d3b6b-d9af-4be4-8229-a94bd1fe5767')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '4f8a4989-dd4f-4f8d-921b-435833f930f3')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('4f8a4989-dd4f-4f8d-921b-435833f930f3')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'bd02932b-77f3-4f8c-a343-5dd40371c5b4')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('bd02932b-77f3-4f8c-a343-5dd40371c5b4')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '1599e557-487f-4798-9d14-4d543c816606')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('1599e557-487f-4798-9d14-4d543c816606')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'eec084a7-fc83-4e13-baed-e2bbfd79be50')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('eec084a7-fc83-4e13-baed-e2bbfd79be50')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'c7604507-1028-47ba-9b16-109282a54651')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('c7604507-1028-47ba-9b16-109282a54651')
